...
object NotifUtils {
    ...
    private const val GROUP_KEY_EMAILS = "notifGroup"
    private const val MAX_NOTIF = 5
    ...
    private fun getNotificationBuilder(
        ...
        NotificationCompat.Builder(context, channelId)
            ...
            .setSmallIcon(com.example.submission1.R.mipmap.ic_launcher)
